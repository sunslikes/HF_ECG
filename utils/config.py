...
TEST_PATH = 'test/testA' # 测试集文件夹
# TEST_PATH = 'train' # 测试集文件夹
TEST_CACHE = 'test/cache'
# TEST_CACHE = 'cache'
ANSWAR_PATH = 'test/hf_round1_subA.txt' # 试卷
TEST_LABEL = 'hefei_round1_ansA_20191008.txt' #测试数据答案
# ANSWAR_PATH = 'hf_round1_label.txt' # 试卷
...
SUMMARY_ITER = 50 # 每训练SUMMARY_ITER个批次进行一次评估（计算loss，输出log）
